...
def saida_teste():
    #andar_reto_suave(cm, velocidade)
    #turn(graus, potencia)
    #b_motor.run_target(velocidade, angulo, wait=false)
   
    b_motor.run_target(300,0)
    andar_reto_suave(85,500)
    turn(-46.5,250)
    andar_reto_suave(8.8,500)
    b_motor.run_target(300,-155)
    andar_reto_suave(7,500)
    andar_reto_suave(-8,500)
    b_motor.run_target(250,-90)
