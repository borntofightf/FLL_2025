...
def saida_4():
    ...
    wait(250)
    andar_reto_suave(-19, 220)

    turn(47,100)
    print(hub.imu.heading())
    andar_reto_suave(86.5, 400)
    curva(-90, 100)
    andar_reto_suave(7.2, 100)
    ...
    andar_reto_suave(-5.2, 600)
    b_motor.run_target(1000, -60, wait=False)
    turn(-172, 200)
    a_motor.run_time(1000,3300,wait=False)
    turn(-4, 10)
