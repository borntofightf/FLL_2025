...
def saida_2():
    ...
    b_motor.run_target(1000, -130)
    andar_reto_suave(5.8, 80)
    turn(-90,100)
    andar_reto_suave(9, 100)
    b_motor.run_target(225, -74)
    a_motor.run_angle(500,60,wait=False)
...
def saida_6():
    ...
    andar_reto_suave(-5, 200)
    turn(-47, 150)
    andar_reto_suave(20.5, 200)
    turn(46, 200)
    andar_reto_suave(-15, 300)
    andar_reto_suave(-12, 150)
    andar_reto_suave(11.5, 200)
    turn(-50, 200)
    andar_reto_suave(54, 200)
    turn(-75, 200)
    a_motor.run_time(-500, 1200, wait=False)
