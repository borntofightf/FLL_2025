...
def saida_5():
    ...
    left_motor.run_angle(-200,40)
    andar_reto_suave(-2, 1000)
    
    andar_reto_suave(29.3, 200)
    print(hub.imu.heading())
    turn(-92, 300)
    wait(150)
    print(hub.imu.heading())
    andar_reto_suave(61, 800)
    print(hub.imu.heading())
    right_motor.run_angle(-300, 100)
    ...
    turn(33, 300)
    andar_reto_suave(8.4, 500)
    b_motor.run_target(400, -135)
    andar_reto_suave(-7, 600)
    b_motor.run_target(500, 0, wait=False)
    turn(70, 1000)
    print((timer.time()) / 1000) 
