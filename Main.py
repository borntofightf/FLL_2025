...
def saida_2():
    ...
    left_motor.run_angle(80,110,wait=False)
    right_motor.run_angle(80,110)
    print(hub.imu.heading())
...
def saida_3():
    ...
    a_motor.run_time(-1100,1050,wait=False)
    wait(400)
...
def saida_5():
    ...
    andar_reto_suave(-6.5, 500)
    
    turn(-85, 200)
    andar_reto_suave(11.5, 500)
    turn(-87, 200)
    andar_reto_suave(5.9, 300)
...
def saida_7():
    ...
    andar_reto_suave(-7, 1000)
    left_motor.run_angle(200,110)
    andar_reto_suave(10, 1000)
