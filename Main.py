...
def saida_5():
    ...
    turn(30, 300)
    andar_reto_suave(8.3, 500)
    b_motor.run_target(400, -133,wait=False)
    wait(225)
...
def saida_6():
    ...
    drive_base.reset()
    wait(150)
    a_motor.run_time(-500, 900, wait=False)
    andar_reto(66, 400)
    a_motor.run_time(-500, 975)
    andar_reto(8,280)
    a_motor.run_time(640, 1000)
    andar_reto_suave(-2, 200)
    right_motor.run_angle(250,80)
    andar_reto(1.5,500)
    right_motor.run_time(400,320)
    andar_reto(-6,500)
    turn(-63, 100)
...
def saida_8():
    ...
    b_motor.run_target(50, -76,wait=False)
    andar_reto(-0.8, 150)
    drive_base.stop()
    hub.imu.reset_heading(0)
    drive_base.reset()
    ...
    turn(-46,80)
    turn2(-46, 60)
    andar_reto(45, 250,wa=False)
    b_motor.run_target(20, -78)
    wait(1590)
    b_motor.run_target(100, -59)
    andar_reto(-1, 200)
    drive_base.use_gyro(True)
    drive_base.settings(turn_rate=180,turn_acceleration=125)
    drive_base.curve(-80,45)
    wait(100)
    turn2(-45,110)
    andar_reto(18, 400)
    turn2(44,150)
    drive_base.settings(straight_acceleration=450,straight_speed=375)
    drive_base.use_gyro(False)
    drive_base.straight(-20*10)
    wait(400)
    turn2(45,150)
    drive_base.straight(-5*10)
    turn2(45,150)
    andar_reto(15, 500)
    turn(-48,125)
    andar_reto(49, 800)
    ...
    wait(170)
    b_motor.run_target(280, -112, wait=False)
    andar_reto(-3.8, 500)
