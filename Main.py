...
def saida_6():
    ...
    wait(150)
    print(hub.imu.heading())
    andar_reto_suave(40, 250)
    b_motor.run_target(120, -60)
    andar_reto_suave(4, 250)
    andar_reto_suave(-6, 200)
    turn(-45, 85)
    print(hub.imu.heading())
