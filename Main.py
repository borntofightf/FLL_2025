...
def saida_1():
    ...
    turn(-46, 200)
    print(hub.imu.heading())
    andar_reto_suave(12,400)
    a_motor.run_time(1000,1000,wait=False)
    wait(300)
    andar_reto_suave(-4.5,600)
    turn(-80, 250)
...
def saida_6():
    ...
    a_motor.run_time(-1000, 50, wait=False)
    ...
    b_motor.run_target(80, 0, wait=False)
    wait(300)
    turn(-20, 200)
    andar_reto(30, 200)
    turn(59, 150)
    ...
    andar_reto(7, 150)
    turn(-40.5, 300)
    andar_reto_suave(3.3, 200)
    turn(-22, 900)
    andar_reto_suave(-6.5, 200)
    turn(-73, 250)
    andar_reto_suave(-22,300)
    a_motor.run_angle(1000, 345)
    andar_reto_suave(-8, 800)
    andar_reto_suave(8, 800)
    andar_reto_suave(-20,900)
    a_motor.run_angle(-400, 225,wait=False)
    andar_reto_suave(41,300)
    turn(-90, 300)
    a_motor.run_angle(-300, 200, wait=False)
    right_motor.run_time(1000,2400, wait=False)
    left_motor.run_time(700,2200)
...
def saida_7():
    ...
    andar_reto_suave(-6, 1000)
    right_motor.run_angle(-200,50)
    turn(30,300)
    andar_reto(5, 500)
